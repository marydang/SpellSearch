...
-- Strings that will be loaded into Global state
local g_strings = {
   -- FONT constants
   RED_FONT_COLOR_CODE = "RED",
   FONT_COLOR_CODE_CLOSE = "/FONT",

   -- Descriptions
   PLAYERSTAT_BASE_STATS = "Base Stats",
   REFORGE = "Reforge",
   ENCHANTS = "Enchants",
   ITEM_SET_BONUS = "Item Set Bonus",
   ITEM_SOCKET_BONUS = "Item Socket Bonus",
   ...
   ITEM_MOD_CRIT_MELEE_RATING_SHORT = "CRIT_MELEE_RATING",
   ITEM_MOD_CRIT_RANGED_RATING_SHORT = "CRIT_RANGED_RATING",
   ITEM_MOD_CRIT_RATING_SHORT = "CRIT_RATING",
   ITEM_MOD_CRIT_SPELL_RATING_SHORT = "CRIT_SPELL_RATING",
   ITEM_MOD_CRIT_TAKEN_MELEE_RATING_SHORT = "CRIT_TAKEN_MELEE_RATING",
   ITEM_MOD_CRIT_TAKEN_RANGED_RATING_SHORT = "CRIT_TAKEN_RANGED_RATING",
   ITEM_MOD_CRIT_TAKEN_RATING_SHORT = "CRIT_TAKEN_RATING",
   ITEM_MOD_CRIT_TAKEN_SPELL_RATING_SHORT = "CRIT_TAKEN_SPELL_RATING",
   ITEM_MOD_DAMAGE_PER_SECOND_SHORT = "DAMAGE_PER_SECOND",
   ITEM_MOD_DEFENSE_SKILL_RATING_SHORT = "DEFENSE_SKILL_RATING",
   ...
   ITEM_MOD_HASTE_MELEE_RATING_SHORT = "HASTE_MELEE_RATING",
   ITEM_MOD_HASTE_RANGED_RATING_SHORT = "HASTE_RANGED_RATING",
   ITEM_MOD_HASTE_RATING_SHORT = "HASTE_RATING",
   ITEM_MOD_HASTE_SPELL_RATING_SHORT = "HASTE_SPELL_RATING",
   ITEM_MOD_HEALTH_REGENERATION_SHORT = "HEALTH_REGENERATION",
   ITEM_MOD_HEALTH_REGEN_SHORT = "HEALTH_REGEN",
   ITEM_MOD_HEALTH_SHORT = "HEALTH",
   ITEM_MOD_HIT_MELEE_RATING_SHORT = "HIT_MELEE_RATING",
   ITEM_MOD_HIT_RANGED_RATING_SHORT = "HIT_RANGED_RATING",
   ITEM_MOD_HIT_RATING_SHORT = "HIT_RATING",
   ITEM_MOD_HIT_SPELL_RATING_SHORT = "HIT_SPELL_RATING",
   ITEM_MOD_HIT_TAKEN_MELEE_RATING_SHORT = "HIT_TAKEN_MELEE_RATING",
   ITEM_MOD_HIT_TAKEN_RANGED_RATING_SHORT = "HIT_TAKEN_RANGED_RATING",
   ITEM_MOD_HIT_TAKEN_RATING_SHORT = "HIT_TAKEN_RATING",
   ITEM_MOD_HIT_TAKEN_SPELL_RATING_SHORT = "HIT_TAKEN_SPELL_RATING",
   ITEM_MOD_INTELLECT_SHORT = "INTELLECT",
   ITEM_MOD_MANA_REGENERATION_SHORT = "MANA_REGENERATION",
   ITEM_MOD_MANA_SHORT = "MANA",
   ITEM_MOD_MASTERY_RATING_SHORT = "MASTERY_RATING",
   ITEM_MOD_MELEE_ATTACK_POWER_SHORT = "MELEE_ATTACK_POWER",
   ITEM_MOD_PARRY_RATING_SHORT = "PARRY_RATING",
   ITEM_MOD_POWER_REGEN0_SHORT = "POWER_REGEN0",
   ITEM_MOD_POWER_REGEN1_SHORT = "POWER_REGEN1",
   ITEM_MOD_POWER_REGEN2_SHORT = "POWER_REGEN2",
   ITEM_MOD_POWER_REGEN3_SHORT = "POWER_REGEN3",
   ITEM_MOD_POWER_REGEN4_SHORT = "POWER_REGEN4",
   ITEM_MOD_POWER_REGEN5_SHORT = "POWER_REGEN5",
   ITEM_MOD_POWER_REGEN6_SHORT = "POWER_REGEN6",
   ITEM_MOD_RANGED_ATTACK_POWER_SHORT = "RANGED_ATTACK_POWER",
   ITEM_MOD_RESILIENCE_RATING_SHORT = "RESILIENCE_RATING",
   ITEM_MOD_SPELL_DAMAGE_DONE_SHORT = "SPELL_DAMAGE_DONE",
   ITEM_MOD_SPELL_HEALING_DONE_SHORT = "SPELL_HEALING_DONE",
...
function UIDropDownMenu_AddButton(...)
end
...
function UIDropDownMenu_SetText(...)
end

function UIDropDownMenu_JustifyText(...)
end

local function MakeMagicTable()
   local createString = "Create"
   local nullFunc = function(...) end
   local frame = {}
   local mt = {}
   mt.__index = function(table, key)
      if string.sub(key, 1, string.len(createString)) == createString then
         table[key] = function(...) return MakeMagicTable() end
      else
         table[key] = nullFunc
      end
      return table[key]
...
-- Emulate GetAddonMetadata
function GetAddOnMetadata(name, version)
   return "TEST"
end
...
-- Load the strings into _G.
for k,v in pairs(g_strings) do
   _G[k] = v
end
